...
import { Form, Dropdown, Loader, Input, Checkbox } from 'semantic-ui-react';
...
class TemplateAdd extends Component {
    ...
    validate = () => {
        ...
        if (easy === "" || hard === "" || medium === "" || passCore === "" || duration === "" || language === "" || testName === "") {
            if (easy === "") {
                isError = true;
    ...
    sendData() {
        ...
        if (!err) {
            ...
            let dataTemplate = {
                ...
                passScore,
                duration,
                defaultEntryTest: defaultEntry
            }
            const userToken = localStorage.getItem('userToken');
            axios.post(`${config.host}/createTemplate`, { dataTemplate }, { headers: { userToken } })
                .then(res => {
                    if (res.status === 204) {
                        this.setState({
                ...
                <div className="row justify-content-center cover-layout-editor">
                    <div className="col-md-6">
                        ...
                        <Form>
                            ...
                            < label className="cover-label">Default EntryTest</label>
                            <div>
...
export default connect(null, { showNav })(TemplateAdd);